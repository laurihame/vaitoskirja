...
\usepackage{beamerthemesplit,xmpmulti} 
...
\begin{frame}
  \frametitle{Bussi, taksi ja kysyntäohjautuva joukkoliikenne}   % Insert frame title between curly braces
  \begin{columns}[c]
  \column{2.5in}  % slides are 3in high by 5in wide
  \begin{itemize}
\item
...
\end{frame}
    ...
    \begin{frame}
  \frametitle{Kysyntäohjautuvan joukkoliikenteen stokastinen verkkomalli}   % Insert frame title between curly braces
\begin{itemize}
 \item 
...
\section{Päätelmät}
\begin{frame}
  \frametitle{Yleisiä havaintoja}   % Insert frame title between curly braces
\begin{itemize}
\item
